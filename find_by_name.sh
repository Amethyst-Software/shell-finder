...
MOVE_FLAT=5
DELETE=6
declare -a SUFFIX_SETS=(-archive 7z rar zip -code c cc cp cpp cs h hpp js m mm pas php py s sh -image eps gif heic jpeg jpg png tiff -text doc docx htm html pdf rtf txt xls xlsx -video 3gp avi flv m4v mkv mov mp4 mpeg mpg webm wmv)
STR_FILES="files"
cols=$(tput cols)
bold=$(tput bold)
normal=$(tput sgr0)
